...
{
 $sql_query="SELECT * FROM sample1 WHERE id=".$_GET['edit_id'];
...
if(isset($_POST['btn-update']))
{
 ...
 // // sql query for update data into database
  $sql_query = "UPDATE sample1 SET first_name='$first_name',last_name='$last_name',user_city='$city_name' WHERE id=".$_GET['edit_id'];
   mysql_query($sql_query);
 // sql query for update data into database 
}
